...
[Source code](https://github.com/Smithsonian/NMNH-Ocean-DNA/blob/main/scripts/data_management/DNA_QC/run_DNA_QC.sh)
...
Decide where you want to store the QC reports and navigate there on the command line. Then download the [`run_DNA_QC.sh`](https://github.com/Smithsonian/NMNH-Ocean-DNA/blob/main/scripts/data_management/DNA_QC/run_DNA_QC.sh) script. For example:
