...
[python source code](https://github.com/Smithsonian/NMNH-Ocean-DNA/blob/main/scripts/data_management/raw_sequence_validate/validate_seq_data.py)

[bash source code](https://github.com/Smithsonian/NMNH-Ocean-DNA/blob/main/scripts/data_management/raw_sequence_validate/validate_seq_data.sh)
...
[Example MAP_FILE](https://github.com/Smithsonian/NMNH-Ocean-DNA/blob/main/scripts/data_management/raw_sequence_validate/example_map_file.txt).
