...
```
LAB-{LAB_SEQUENCING_ID}_{PROJECT_DESCRIPTION}_mapfile.csv
```

For example: `LAB-240925VL008474AAG5MNMM5_IRL-2024-07_mapfile.csv`

Where "240925VL008474AAG5MNMM5" is the LAB sequencing run ID and and "IRL-2024-07" is the description given by the project owner. 
If you do not know the LAB sequencing run ID, please contact LAB personnel.
