...
```
LAB-{LAB_RUN_NAME}_{PROJECT_DESCRIPTION}_mapfile.csv
```

For example: `LAB-240925VL008474AAG5MNMM5_IRL-2024-07_mapfile.csv`

Where "240925VL008474AAG5MNMM5" is the LAB sequencing run name (with underscores removed) and "IRL-2024-07" is your description of the sequencing project. 
...
```
LAB-{LAB_RUN_NAME}_{PROJECT_DESCRIPTION}
```
